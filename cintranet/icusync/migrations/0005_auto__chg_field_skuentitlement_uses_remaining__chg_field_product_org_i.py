...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SKUEntitlement.uses_remaining'
        db.alter_column(u'icusync_skuentitlement', 'uses_remaining', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Product.org_id'
        db.alter_column(u'icusync_product', 'org_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Product.sold'
        db.alter_column(u'icusync_product', 'sold', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Product.initial'
        db.alter_column(u'icusync_product', 'initial', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Product.eactivities_id'
        db.alter_column(u'icusync_product', 'eactivities_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'SKU.org_id'
        db.alter_column(u'icusync_sku', 'org_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'SKU.sold'
        db.alter_column(u'icusync_sku', 'sold', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'SKU.initial'
        db.alter_column(u'icusync_sku', 'initial', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'SKU.eactivities_id'
        db.alter_column(u'icusync_sku', 'eactivities_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'SKUEntitlement.uses_remaining'
        db.alter_column(u'icusync_skuentitlement', 'uses_remaining', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'Product.org_id'
        db.alter_column(u'icusync_product', 'org_id', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'Product.sold'
        db.alter_column(u'icusync_product', 'sold', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'Product.initial'
        db.alter_column(u'icusync_product', 'initial', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'Product.eactivities_id'
        db.alter_column(u'icusync_product', 'eactivities_id', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'SKU.org_id'
        db.alter_column(u'icusync_sku', 'org_id', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'SKU.sold'
        db.alter_column(u'icusync_sku', 'sold', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'SKU.initial'
        db.alter_column(u'icusync_sku', 'initial', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'SKU.eactivities_id'
        db.alter_column(u'icusync_sku', 'eactivities_id', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))
    ...
    models = {
        ...
        u'icusync.product': {
            ...
            'eactivities_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'initial': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'}),
            'org_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'sold': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        u'icusync.sku': {
        ...
        u'icusync.skuentitlement': {
            ...
            'uses_remaining': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        ...
        u'ticketing.baseticketinfo': {
            ...
            'count_towards_capacity': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
        ...
        u'ticketing.film': {
            ...
            'length': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            ...
            'youtube_id': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20', 'blank': 'True'})
        },
        u'ticketing.punter': {
        ...
        u'ticketing.showing': {
            ...
            'whats_on_id': ('django.db.models.fields.PositiveIntegerField', [], {'default': 'None', 'null': 'True'})
        },
        u'ticketing.showingsweek': {
            'Meta': {'object_name': 'ShowingsWeek'},
            'additional_bit': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '120', 'blank': 'True'}),
