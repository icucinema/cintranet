...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Showing.primary_event'
        db.alter_column(u'ticketing_showing', 'primary_event_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['ticketing.Event']))
        # Adding field 'Film.sorting_name'
        db.add_column(u'ticketing_film', 'sorting_name',
                      self.gf('django.db.models.fields.CharField')(default='OOPS I DID IT AGAIN', max_length=256),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Showing.primary_event'
        raise RuntimeError("Cannot reverse this migration. 'Showing.primary_event' and its values cannot be restored.")
        # Deleting field 'Film.sorting_name'
        db.delete_column(u'ticketing_film', 'sorting_name')
