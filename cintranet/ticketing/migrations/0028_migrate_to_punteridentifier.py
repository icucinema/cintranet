...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for punter in orm.Punter.objects.all():
            if punter.swipecard and punter.swipecard != '':
                pi = orm.PunterIdentifier(punter=punter, type='swipe', value=punter.swipecard)
                pi.save()

    def backwards(self, orm):
        "Write your backwards methods here."
        raise RuntimeError("Cannot reverse this migration without loss of data.")
