...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BoxOfficeReturn.additional_bit'
        db.add_column(u'ticketing_boxofficereturn', 'additional_bit',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=120, blank=True),
                      keep_default=False)

        # Adding field 'ShowingsWeek.additional_bit'
        db.add_column(u'ticketing_showingsweek', 'additional_bit',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=120, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BoxOfficeReturn.additional_bit'
        db.delete_column(u'ticketing_boxofficereturn', 'additional_bit')

        # Deleting field 'ShowingsWeek.additional_bit'
        db.delete_column(u'ticketing_showingsweek', 'additional_bit')
    ...
    models = {
        ...
        u'ticketing.punteridentifier': {
            'Meta': {'unique_together': "(('type', 'value'),)", 'object_name': 'PunterIdentifier'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'punter': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'identifiers'", 'to': u"orm['ticketing.Punter']"}),
            'type': ('django.db.models.fields.CharField', [], {'default': "'swipe'", 'max_length': '120'}),
