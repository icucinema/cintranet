...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.additional_audience'
        db.add_column(u'ticketing_event', 'additional_audience',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.additional_audience'
        db.delete_column(u'ticketing_event', 'additional_audience')
