...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Film.rotten_tomatoes_id'
        db.add_column(u'ticketing_film', 'rotten_tomatoes_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'Film.short_description'
        db.add_column(u'ticketing_film', 'short_description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Film.hero_image_url'
        db.add_column(u'ticketing_film', 'hero_image_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Film.rotten_tomatoes_id'
        db.delete_column(u'ticketing_film', 'rotten_tomatoes_id')

        # Deleting field 'Film.short_description'
        db.delete_column(u'ticketing_film', 'short_description')

        # Deleting field 'Film.hero_image_url'
        db.delete_column(u'ticketing_film', 'hero_image_url')
