...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Film.royalties_percent'
        db.add_column(u'ticketing_film', 'royalties_percent',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Film.royalties_minimum'
        db.add_column(u'ticketing_film', 'royalties_minimum',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Film.royalties_percent'
        db.delete_column(u'ticketing_film', 'royalties_percent')

        # Deleting field 'Film.royalties_minimum'
        db.delete_column(u'ticketing_film', 'royalties_minimum')
