...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'PunterIdentifier', fields ['type', 'value']
        db.create_unique(u'ticketing_punteridentifier', ['type', 'value'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'PunterIdentifier', fields ['type', 'value']
        db.delete_unique(u'ticketing_punteridentifier', ['type', 'value'])
