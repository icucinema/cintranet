...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Film.youtube_id'
        db.add_column(u'ticketing_film', 'youtube_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'Film.length'
        db.add_column(u'ticketing_film', 'length',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Film.youtube_id'
        db.delete_column(u'ticketing_film', 'youtube_id')

        # Deleting field 'Film.length'
        db.delete_column(u'ticketing_film', 'length')
