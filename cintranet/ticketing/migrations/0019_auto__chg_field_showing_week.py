...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Showing.week'
        db.alter_column(u'ticketing_showing', 'week_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['ticketing.ShowingsWeek']))

    def backwards(self, orm):

        # Changing field 'Showing.week'
        db.alter_column(u'ticketing_showing', 'week_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['ticketing.ShowingsWeek']))
