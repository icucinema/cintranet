...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Film.distributor'
        db.alter_column(u'ticketing_film', 'distributor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['ticketing.Distributor']))

    def backwards(self, orm):

        # Changing field 'Film.distributor'
        db.alter_column(u'ticketing_film', 'distributor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ticketing.Distributor'], null=True, on_delete=models.SET_NULL))
