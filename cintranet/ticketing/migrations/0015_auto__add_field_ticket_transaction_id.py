...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ticket.transaction_id'
        db.add_column(u'ticketing_ticket', 'transaction_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ticket.transaction_id'
        db.delete_column(u'ticketing_ticket', 'transaction_id')
