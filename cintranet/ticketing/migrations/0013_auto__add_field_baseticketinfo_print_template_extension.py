...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseTicketInfo.print_template_extension'
        db.add_column(u'ticketing_baseticketinfo', 'print_template_extension',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaseTicketInfo.print_template_extension'
        db.delete_column(u'ticketing_baseticketinfo', 'print_template_extension')
