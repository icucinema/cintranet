...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        templates = orm.TicketTemplate.objects.filter(name__in=['Members Free Single', 'Members Free Double', 'Members Single', 'Members Double', 'Non-members Single', 'Non-members Double', 'All-Nighter Online', 'All-Nighter On-The-Door', 'Season'])
        templates.update(is_public=True)
        tickets = orm.TicketType.objects.filter(template__in=templates)
        tickets.update(is_public=True)
