...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Punter.cid'
        db.alter_column(u'ticketing_punter', 'cid', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'Punter.login'
        db.alter_column(u'ticketing_punter', 'login', self.gf('django.db.models.fields.CharField')(max_length=64))

    def backwards(self, orm):

        # Changing field 'Punter.cid'
        db.alter_column(u'ticketing_punter', 'cid', self.gf('django.db.models.fields.CharField')(max_length=16))

        # Changing field 'Punter.login'
        db.alter_column(u'ticketing_punter', 'login', self.gf('django.db.models.fields.CharField')(max_length=16))
