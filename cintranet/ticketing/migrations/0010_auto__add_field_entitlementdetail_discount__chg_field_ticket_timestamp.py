...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntitlementDetail.discount'
        db.add_column(u'ticketing_entitlementdetail', 'discount',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Ticket.timestamp'
        db.alter_column(u'ticketing_ticket', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting field 'EntitlementDetail.discount'
        db.delete_column(u'ticketing_entitlementdetail', 'discount')


        # Changing field 'Ticket.timestamp'
        db.alter_column(u'ticketing_ticket', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())
