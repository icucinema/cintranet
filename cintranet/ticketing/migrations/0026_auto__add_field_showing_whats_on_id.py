...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Showing.whats_on_id'
        db.add_column(u'ticketing_showing', 'whats_on_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Showing.whats_on_id'
        db.delete_column(u'ticketing_showing', 'whats_on_id')
