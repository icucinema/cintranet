...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseTicketInfo.is_public'
        db.add_column(u'ticketing_baseticketinfo', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaseTicketInfo.is_public'
        db.delete_column(u'ticketing_baseticketinfo', 'is_public')
