...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PunterIdentifier'
        db.create_table(u'ticketing_punteridentifier', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('punter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ticketing.Punter'])),
            ('type', self.gf('django.db.models.fields.CharField')(default='swipe', max_length=120)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ))
        db.send_create_signal(u'ticketing', ['PunterIdentifier'])

        # Adding index on 'PunterIdentifier', fields ['type', 'value']
        db.create_index(u'ticketing_punteridentifier', ['type', 'value'])


    def backwards(self, orm):
        # Removing index on 'PunterIdentifier', fields ['type', 'value']
        db.delete_index(u'ticketing_punteridentifier', ['type', 'value'])

        # Deleting model 'PunterIdentifier'
        db.delete_table(u'ticketing_punteridentifier')
    ...
    models = {
        ...
        u'ticketing.punteridentifier': {
            'Meta': {'object_name': 'PunterIdentifier', 'index_together': "(('type', 'value'),)"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'punter': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ticketing.Punter']"}),
