...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Showing.film'
        db.delete_column(u'ticketing_showing', 'film_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Showing.film'
        raise RuntimeError("Cannot reverse this migration. 'Showing.film' and its values cannot be restored.")
