...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Showing.primary_event'
        db.add_column(u'ticketing_showing', 'primary_event',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, related_name='primary_showing', unique=True, to=orm['ticketing.Event']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Showing.primary_event'
        db.delete_column(u'ticketing_showing', 'primary_event_id')
    ...
    models = {
        ...
        u'ticketing.showing': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'primary_event': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'primary_showing'", 'unique': 'True', 'to': u"orm['ticketing.Event']"}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {})
        },
        u'ticketing.ticket': {
