...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Showing.is_public'
        db.add_column(u'ticketing_showing', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Showing.banner_text'
        db.add_column(u'ticketing_showing', 'banner_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=280, blank=True),
                      keep_default=False)

        # Adding field 'Film.is_public'
        db.add_column(u'ticketing_film', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Showing.is_public'
        db.delete_column(u'ticketing_showing', 'is_public')

        # Deleting field 'Showing.banner_text'
        db.delete_column(u'ticketing_showing', 'banner_text')

        # Deleting field 'Film.is_public'
        db.delete_column(u'ticketing_film', 'is_public')
