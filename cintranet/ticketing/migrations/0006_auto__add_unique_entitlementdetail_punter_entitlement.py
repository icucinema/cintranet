...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'EntitlementDetail', fields ['punter', 'entitlement']
        db.create_unique(u'ticketing_entitlementdetail', ['punter_id', 'entitlement_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'EntitlementDetail', fields ['punter', 'entitlement']
        db.delete_unique(u'ticketing_entitlementdetail', ['punter_id', 'entitlement_id'])
