...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseTicketInfo.count_towards_capacity'
        db.add_column(u'ticketing_baseticketinfo', 'count_towards_capacity',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaseTicketInfo.count_towards_capacity'
        db.delete_column(u'ticketing_baseticketinfo', 'count_towards_capacity')
